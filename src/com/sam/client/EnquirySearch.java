/**
 * This class represents the Enquiry Search view for staff. 
 * 
...
public class EnquirySearch extends JFrame {
	...
	// constructor
	public EnquirySearch(User user) {
		...
		roundedPanel.setBounds(283, 107, 726, 474);
	   ...
	   // label for displaying logo
		...
		// title for JFrame
		this.setTitle("SAM Enquiry System");
		...
		logoutButton.setBounds(775, 50, 234, 38);
		...
		button_pre.setBounds(169, 440, 114, 23);
		...
		btnNext.setBounds(427, 440, 105, 23);
		...
		btnNext.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// call method to display the next five enquiries	
					j = j + 5;
				Controller.displayNextEnqs(user.getSearchEnqs(), enq1Button,enq2Button,
		...
		lblOf.setBounds(287, 442, 130, 21);
		...
		// set parameters of JLabel
		lbleid.setFont(new Font("Tahoma", Font.BOLD, 11));			
		lbleid.setForeground(Color.WHITE);
		lbleid.setBounds(286, 48, 188, 14);
		...
		lblStaff.setBounds(285, 78, 220, 14);
		roundedPanel.add(lblStaff);
		
		// set parameters of JLabel
		lblStatus.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblStatus.setForeground(Color.WHITE);
		lblStatus.setBounds(499, 78, 220, 14);
		roundedPanel.add(lblStatus);
		
		// set parameters of JLabel
		lblLastUpdated.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblLastUpdated.setForeground(Color.WHITE);
		lblLastUpdated.setBounds(499, 48, 220, 14);
		roundedPanel.add(lblLastUpdated);
		
		// set parameters of JLabel
		name_2.setForeground(Color.WHITE);
		name_2.setFont(new Font("Tahoma", Font.BOLD, 11));
		name_2.setBounds(41, 132, 211, 14);
		roundedPanel.add(name_2);
		
		// set parameters of JLabel
		eid2.setForeground(Color.WHITE);
		eid2.setFont(new Font("Tahoma", Font.BOLD, 11));
		eid2.setBounds(286, 132, 188, 14);
		roundedPanel.add(eid2);
		
		// set parameters of JLabel
		lastUpdated2.setForeground(Color.WHITE);
		lastUpdated2.setFont(new Font("Tahoma", Font.BOLD, 11));
		lastUpdated2.setBounds(499, 132, 220, 14);
		roundedPanel.add(lastUpdated2);
		
		// set parameters of JLabel
		agent2.setForeground(Color.WHITE);
		agent2.setFont(new Font("Tahoma", Font.BOLD, 11));
		agent2.setBounds(41, 162, 220, 14);
		roundedPanel.add(agent2);
		
		// set parameters of JLabel
		staff2.setForeground(Color.WHITE);
		staff2.setFont(new Font("Tahoma", Font.BOLD, 11));
		staff2.setBounds(285, 162, 220, 14);
		roundedPanel.add(staff2);
		
		// set parameters of JLabel
		status2.setForeground(Color.WHITE);
		status2.setFont(new Font("Tahoma", Font.BOLD, 11));
		status2.setBounds(499, 162, 220, 14);
		roundedPanel.add(status2);
		
		// set parameters of JLabel
		name3.setForeground(Color.WHITE);
		name3.setFont(new Font("Tahoma", Font.BOLD, 11));
		name3.setBounds(40, 214, 211, 14);
		roundedPanel.add(name3);
		
		// set parameters of JLabel
		eid3.setForeground(Color.WHITE);
		eid3.setFont(new Font("Tahoma", Font.BOLD, 11));
		eid3.setBounds(285, 214, 188, 14);
		roundedPanel.add(eid3);
		
		// set parameters of JLabel
		lastUpdated3.setForeground(Color.WHITE);
		lastUpdated3.setFont(new Font("Tahoma", Font.BOLD, 11));
		lastUpdated3.setBounds(498, 214, 220, 14);
		roundedPanel.add(lastUpdated3);
		
		// set parameters of JLabel
		agent3.setForeground(Color.WHITE);
		agent3.setFont(new Font("Tahoma", Font.BOLD, 11));
		agent3.setBounds(40, 244, 220, 14);
		roundedPanel.add(agent3);
		
		// set parameters of JLabel
		staff3.setForeground(Color.WHITE);
		staff3.setFont(new Font("Tahoma", Font.BOLD, 11));
		staff3.setBounds(284, 244, 220, 14);
		roundedPanel.add(staff3);
		
		// set parameters of JLabel
		status3.setForeground(Color.WHITE);
		status3.setFont(new Font("Tahoma", Font.BOLD, 11));
		status3.setBounds(498, 244, 220, 14);
		roundedPanel.add(status3);
		
		// set parameters of JLabel
		name4.setForeground(Color.WHITE);
		name4.setFont(new Font("Tahoma", Font.BOLD, 11));
		name4.setBounds(41, 294, 211, 14);
		roundedPanel.add(name4);
		
		// set parameters of JLabel
		eid4.setForeground(Color.WHITE);
		eid4.setFont(new Font("Tahoma", Font.BOLD, 11));
		eid4.setBounds(286, 294, 188, 14);
		roundedPanel.add(eid4);
		
		// set parameters of JLabel
		lastUpdated4.setForeground(Color.WHITE);
		lastUpdated4.setFont(new Font("Tahoma", Font.BOLD, 11));
		lastUpdated4.setBounds(499, 294, 220, 14);
		roundedPanel.add(lastUpdated4);
		
		// set parameters of JLabel
		agent4.setForeground(Color.WHITE);
		agent4.setFont(new Font("Tahoma", Font.BOLD, 11));
		agent4.setBounds(41, 324, 220, 14);
		roundedPanel.add(agent4);
		
		// set parameters of JLabel
		staff4.setForeground(Color.WHITE);
		staff4.setFont(new Font("Tahoma", Font.BOLD, 11));
		staff4.setBounds(285, 324, 220, 14);
		roundedPanel.add(staff4);
		
		// set parameters of JLabel
		status4.setForeground(Color.WHITE);
		status4.setFont(new Font("Tahoma", Font.BOLD, 11));
		status4.setBounds(499, 324, 220, 14);
		roundedPanel.add(status4);
		
		// set parameters of JLabel
		name5.setForeground(Color.WHITE);
		name5.setFont(new Font("Tahoma", Font.BOLD, 11));
		name5.setBounds(41, 375, 211, 14);
		roundedPanel.add(name5);
		
		// set parameters of JLabel
		eid5.setForeground(Color.WHITE);
		eid5.setFont(new Font("Tahoma", Font.BOLD, 11));
		eid5.setBounds(286, 375, 188, 14);
		roundedPanel.add(eid5);
		
		// set parameters of JLabel
		lastUpdated5.setForeground(Color.WHITE);
		lastUpdated5.setFont(new Font("Tahoma", Font.BOLD, 11));
		lastUpdated5.setBounds(499, 375, 220, 14);
		roundedPanel.add(lastUpdated5);
		
		// set parameters of JLabel
		agent5.setForeground(Color.WHITE);
		agent5.setFont(new Font("Tahoma", Font.BOLD, 11));
		agent5.setBounds(41, 405, 220, 14);
		roundedPanel.add(agent5);
		
		// set parameters of JLabel
		staff5.setForeground(Color.WHITE);
		staff5.setFont(new Font("Tahoma", Font.BOLD, 11));
		staff5.setBounds(285, 405, 220, 14);
		roundedPanel.add(staff5);
		
		// set parameters of JLabel
		status5.setForeground(Color.WHITE);
		status5.setFont(new Font("Tahoma", Font.BOLD, 11));
		status5.setBounds(499, 405, 220, 14);
		...
		enq1Button.setBounds(30, 39, 668, 70);
		...
		enq2Button.setBounds(30, 120, 668, 70);
		...
		enq3Button.setBounds(30, 201, 668, 70);
		...
		enq4Button.setBounds(30, 282, 668, 70);
		...
		enq5Button.setBounds(30, 363, 668, 70);
