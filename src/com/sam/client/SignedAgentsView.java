/**
 * This class represents the Signed Agents view for staff members. 
 * 
...
public class SignedAgentsView extends JFrame {
	...
	// constructor
	public SignedAgentsView(User user) {
	   ...
	   // label for displaying logo
		...
		logoLabel.setBounds(13, 0, 242, 93);
		...
		// creation of JLabel	
		JLabel lblViewApplications = new JLabel("Contracted Agents:");
		...
		Controller.addViewAgentButtonListeners(user, agent1Button, agent2Button,
				agent3Button, agent4Button, agent5Button, lblcompanyName,
				companyName2, companyName3, companyName4, companyName5);
		agent5Button.setVisible(false);

		Controller.populateSignedAgents(signedAgents, user);

		Controller.nextAgents(signedAgents, agent1Button, agent2Button,
				agent3Button, agent4Button, agent5Button, lblcontactName,
				lblcompanyName, stats1, lblAccountManager, lblStatus,
				lblLastContacted, contactName_2, companyName2, stats2,
				AccountManager2, status2, lastContacted2, contactName3,
				companyName3, stats3, AccountManager3, status3, lastContacted3,
				contactName4, companyName4, stats4, AccountManager4, status4,
				lastContacted4, contactName5, companyName5, stats5,
				AccountManager5, status5, lastContacted5, lblOf, i, j);
		...
		roundedPanel_1.setBounds(13, 101, 245, 474);
