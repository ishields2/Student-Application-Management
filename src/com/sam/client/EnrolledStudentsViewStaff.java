/**
 * This class represents the Enrolled Student view for staff. 
 * 
...
public class EnrolledStudentsViewStaff extends JFrame {
	...
	// constructor
	public EnrolledStudentsViewStaff(User user) {
	   ...
	   // label for displaying logo
		...
		button_pr.setBounds(182, 442, 114, 23);
		...
		for(Application button_9 : user.getUserApplications()){
			if(button_9.getAppStatus().equals("Enrolled")){
				enrolledStudents.add(button_9);
			}
		}
